...
export default function NotFound() {
  return (
    <div style={{ padding: "100px 0 120px", maxWidth: 560 }}>
      ...
      <p style={{ fontFamily: "var(--font-serif)", fontSize: 18, lineHeight: 1.55, color: "rgba(0, 0, 128,.7)", marginTop: 14 }}>
        The link may be stale, or the topic was renamed. Try the knowledge graph or press
        {" "}<kbd style={{ fontFamily: "var(--font-mono)", fontSize: 12, border: "1px solid rgba(0, 0, 128,.25)", borderRadius: 4, padding: "1px 6px" }}>⌘K</kbd>{" "}
        to search.
      </p>
